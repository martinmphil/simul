...
const e = (function () {
  ...
  enc.get_maxPlayerNbrs = () => maxPlayerNbrs
...
function preparePlayerNumbersSection () {
  ...
  for (let i = 1; i <= e.get_maxPlayerNbrs(); i++) {
    let el = document.querySelector('#pbttn' + i)
...
function prepareKeypads () {
  for (let i = 1; i <= 9; i++) {
    let el = document.querySelector('#usNbrKey' + i)
    el.addEventListener('click', () => {
      usKeypadButtonFn(i)
    }
    )
  ...
  for (let i = 1; i <= 9; i++) {
    let el = document.querySelector('#themNbrKey' + i)
    el.addEventListener('click', () => {
